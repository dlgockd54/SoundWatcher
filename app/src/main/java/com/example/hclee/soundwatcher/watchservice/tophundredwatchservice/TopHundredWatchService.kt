...
class TopHundredWatchService : Service() {
    private val TAG: String = TopHundredWatchService::class.java.simpleName
    ...
    override fun onCreate() {
        ...
        mTopHundredPullingThread = TopHundredPullingThread(this,
            OnPullFinishListenerImpl(this@TopHundredWatchService)
        )
    }
